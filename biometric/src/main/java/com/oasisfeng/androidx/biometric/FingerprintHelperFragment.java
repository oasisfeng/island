...
/**
 * A fragment that wraps the FingerprintManager and has the ability to continue authentication
 ...
 * @hide
 */
@RequiresApi(Build.VERSION_CODES.M) @RestrictTo(RestrictTo.Scope.LIBRARY)
public class FingerprintHelperFragment extends Fragment {
     ...
     */
    private boolean handlePreAuthenticationErrors(FingerprintManager fingerprintManager) {
    ...
    static FingerprintManager.CryptoObject wrapCryptoObject(
