...
/**
 * Utility class to scale icons to match material design guideline.
 *
 * Derived from launcher3.
 */
public class IconNormalizer {
    ...
    /**
     * @param maxSize Use twice the icon size as maximum size to avoid scaling down twice.
     */
    public IconNormalizer(int maxSize) {
        mMaxSize = maxSize;
