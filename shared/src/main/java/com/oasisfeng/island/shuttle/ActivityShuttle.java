 ...
 */
public abstract class ActivityShuttle extends InternalBroadcastReceiver {
	...
	public static void startActivityAsUser(final Context context, final Intent intent, final UserHandle user) {
		...
		context.sendBroadcastAsUser(shuttle_intent.setComponent(getComponent(context, ActivityShuttle.class)), user);
	}
